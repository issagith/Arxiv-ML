...
def main():
    ...
    scraper = ArxivScraper(csv_file=csv_filename, csv_mode="per_article", rate_limit=3, retry_wait=30)
    articles = scraper.scrape(chronological=True, categories=test_cats, max_articles=10000, batch_size=200)
